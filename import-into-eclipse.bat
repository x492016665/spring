...
SET COMMAND=C:/Root/ProgramFiles/gradle-2.9/bin/gradle --no-daemon cleanEclipse :spring-oxm:compileTestJava eclipse -x :eclipse
...
set COMMAND=C:/Root/ProgramFiles/gradle-2.9/bin/gradle --no-daemon :eclipse
